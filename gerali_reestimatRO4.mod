...
varexo  e_z e_A_e e_j e_me e_mi e_mk_d e_mk_bh e_mk_be e_qk e_r_ib e_y e_l e_eps_K_b e_vi ;  //13 varexo
...
parameters  
            ...
            mk_d_ss mk_bh_ss mk_be_ss r_be_ss  r_bh_ss r_k_ss vi_ss               // BANKS (SS)
            ...
            rho_mk_d rho_mk_be rho_mk_bh rho_ee_qk rho_eps_l rho_eps_K_b rho_vi    // SHOCKS
            ;
...
eps_d        = -0.323742047;                                                   % elast. of subst. of deposits 
eps_bh       = 2.368203257;
eps_be       = 1.407382856
; 
...
vi_ss=0.14;                                                                % Banking Capital ratio over Loans (BaselII)
...
dc = 100*(0.007057019 + C - C(-1));
dinv = 100*(0.005203809 + I - I(-1));
infobs = 100*(0.010118352 + pie);
wages = 100*(0.027365079 + PIW);
hp = 100*(0.001430045 + q_h - q_h(-1));
loansH = 100*(0.034691799 + BH - BH(-1));
loansF = 100*(0.012725079 + BE - BE(-1)); 
deposits = 100*(0.022065761 + D - D(-1));   
...
stderr e_vi, inv_gamma_pdf, 0.01, 0.05;
...
estimation(datafile=dataGeralinew3,mh_replic=100000,mh_nblocks=10,mh_drop=0.5,mh_jscale=0.030,filtered_vars,mode_compute=6,smoother) 
