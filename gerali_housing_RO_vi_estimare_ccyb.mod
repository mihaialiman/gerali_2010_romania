...
exp(vi)= (1-rho_vi)*vi_ss + phi_vi*((exp(b_h)+exp(b_e))/(exp(Y1(-3))+exp(Y1(-2))+exp(Y1(-1))+exp(Y1))-(exp(b_h)+exp(b_e))/(4*exp(Y1)))+e_vi;
...
dinv = 100*(0.005203809 + I - I(-1)+I_h-I_h(-1));
...
stderr e_qh, inv_gamma_pdf, 0.01, 0.05;
