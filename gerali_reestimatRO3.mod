...
exp(vi)       = (1- rho_vi)*vi_ss              + rho_vi * exp(vi(-1))          + e_vi;
...
estimation(datafile=dataGeralinew2,mh_replic=100000,mh_nblocks=10,mh_drop=0.5,mh_jscale=0.030,filtered_vars,mode_compute=6,smoother) 
