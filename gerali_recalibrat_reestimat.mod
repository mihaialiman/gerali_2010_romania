...
varexo e_A_e e_eps_K_b e_j e_l e_me e_mi e_mk_be e_mk_bh e_mk_d e_r_ib e_qk e_y e_z e_vi;  //13 varexo
...
vi_ss=0.16;                                                                % Banking Capital ratio over Loans (Basel II)
...
interestH=8.02808;
interestF=9.33265;
inflation=0.000000000000736338;
loansH=63.983;
loansF=305.853;
output=220.84;
consumption=177.375;
...
var e_mi        = 0.0100^2;
var e_mk_d      = 0.2115^2;
var e_mk_bh     = 0.3339^2;
var e_mk_be     = 0.0133^2;
var e_qk        = 0.0932^2;
var e_r_ib      = 0.0036^2;
var e_y         = 1.3004^2;
var e_l         = 0.2601^2;
var e_eps_K_b   = 0.1473^2;
var e_vi = 0.2661^2;
end;
